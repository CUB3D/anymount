...
impl GenFSProps for DerCertF {
    const FORMAT_NAME: &'static str = "der";
}

impl GenFS for DerCertF {
        ...
        Self: Sized,
    {
        ...
        let mmap = f.mmap;
        let x509 = openssl::x509::X509::from_der(mmap)?;
        ...
        Self: Sized,
    {
        ...
        Ok(openssl::x509::X509::from_der(f).is_ok())
    }
